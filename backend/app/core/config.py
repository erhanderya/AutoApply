...
class Settings(BaseSettings):
    ...
    analyzer_model: str = Field(default="meta-llama/llama-3.1-8b-instruct:free", alias="ANALYZER_MODEL")
    writer_model: str = Field(default="meta-llama/llama-3.1-8b-instruct:free", alias="WRITER_MODEL")

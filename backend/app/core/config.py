...
class Settings(BaseSettings):
    ...
    cv_parser_model: str = Field(default="openai/gpt-4o-mini", alias="CV_PARSER_MODEL")
    cv_refiner_model: str = Field(default="openai/gpt-4o-mini", alias="CV_REFINER_MODEL")
    analyzer_model: str = Field(default="openai/gpt-4o-mini", alias="ANALYZER_MODEL")
    writer_model: str = Field(default="openai/gpt-4o-mini", alias="WRITER_MODEL")
    ...
    interview_research_model: str = Field(default="openai/gpt-4o-mini", alias="INTERVIEW_RESEARCH_MODEL")
    interview_question_model: str = Field(default="openai/gpt-4o-mini", alias="INTERVIEW_QUESTION_MODEL")
